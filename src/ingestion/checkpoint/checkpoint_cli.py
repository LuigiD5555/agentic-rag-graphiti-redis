...
class CheckpointCLI:
    ...
    def _list_scan_runs(self, cache_manager):
        ...
        from src.ingestion.checkpoint.scan_checkpointer import ScanCheckpointer
    ...
    def _queue_stats(self, cache_manager):
        ...
        from src.ingestion.checkpoint.ingest_queue import IngestQueue
    ...
    def _chunk_stats(self, cache_manager):
        ...
        from src.ingestion.checkpoint.chunk_registry import ChunkRegistry
