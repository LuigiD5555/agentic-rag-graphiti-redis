...
class SchemaManager:
    """
    Encapsulates schema and tenant lifecycle concerns for a single Weaviate class.

    Keeps WeaviateRepository focused on vector operations while centralizing
    collection creation and tenant handling.
    """
