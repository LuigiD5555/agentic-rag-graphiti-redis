...
def _build_openai_family(config: object) -> ApiRouterFamily:
    ...
    from src.api.compatibility.openai.chat import get_rag_orchestrator as openai_chat_get_rag
    from src.api.compatibility.openai.responses import get_rag_orchestrator as openai_responses_get_rag
    from src.api.compatibility.openai.embeddings import get_embedding_service as openai_get_embedding
...
def _build_ollama_family(config: object) -> ApiRouterFamily:
    ...
    from src.api.compatibility.ollama.router import get_rag_orchestrator as ollama_get_rag
    from src.api.compatibility.ollama.router import get_embedding_service as ollama_get_embedding
    from src.api.compatibility.ollama.router import get_chat_memory_manager as ollama_get_chat_memory
    from src.api.compatibility.ollama.router import get_snapshot_scheduler as ollama_get_scheduler
