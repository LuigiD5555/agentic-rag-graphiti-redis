...
from src.backends.storage.vector.registry import (
    get_vector_store_factory,
    register_vector_store,
)
from src.backends.storage.vector.backends.chroma import build_chroma_repository
...
def _build_weaviate_repository(config: Any, store_cfg: Mapping[str, Any], alias: str) -> VectorInterface:
    ...
    from src.backends.storage.vector.weaviate_repository.repository import WeaviateRepository
    from src.backends.storage.vector.weaviate_repository.schema import SchemaManager
