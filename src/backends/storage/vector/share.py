...
Usage:
  python -m src.backends.storage.vector.share --id <hash_or_external_id> --visibility public|private [--tenant TENANT]
  python -m src.backends.storage.vector.share --id <hash_or_external_id> --grant user1,user2      [--tenant TENANT]
"""
...
from src.workflows.query.audit.log_registry import audit  # keep your existing audit hook
