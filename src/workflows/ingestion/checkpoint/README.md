...
from src.workflows.ingestion.checkpoint import ScanCheckpointer
...
python -m src.workflows.ingestion.checkpoint.checkpoint_cli scan:list

# Show detailed status of a scan run
python -m src.workflows.ingestion.checkpoint.checkpoint_cli scan:status <run_id>

# Resume an interrupted scan
python -m src.workflows.ingestion.checkpoint.checkpoint_cli scan:resume <run_id>
```
...
python -m src.workflows.ingestion.checkpoint.checkpoint_cli queue:stats

# List pending jobs
python -m src.workflows.ingestion.checkpoint.checkpoint_cli queue:list --limit 20

# List failed jobs in dead letter queue
python -m src.workflows.ingestion.checkpoint.checkpoint_cli queue:dlq --limit 20

# Clear all queue data (DANGEROUS)
python -m src.workflows.ingestion.checkpoint.checkpoint_cli queue:clear --force
```
...
python -m src.workflows.ingestion.checkpoint.checkpoint_cli chunk:stats

# Show chunk status for a specific file
python -m src.workflows.ingestion.checkpoint.checkpoint_cli chunk:file <file_id>
```
