...
from experiments.swarm_rag.knowledge.privacy_scrubber import run_privacy_scrubber, _regex_scrub
...
class TestPipelineWithMemoryAndPrivacy:
    ...
    def test_build_with_memory_retrieval(self):
        ...
        from experiments.swarm_rag.knowledge.memory_retrieval import build_memory_retrieval
        from experiments.swarm_rag.specialists import query_rewriter, fact_extractor, evidence_ranker
